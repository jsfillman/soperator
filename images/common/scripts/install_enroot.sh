...
# Download enroot
curl -fSsL -o /tmp/enroot_3.5.0-1_arm64.deb https://github.com/NVIDIA/enroot/releases/download/v3.5.0/enroot_3.5.0-1_arm64.deb
curl -fSsL -o /tmp/enroot+caps_3.5.0-1_arm64.deb https://github.com/NVIDIA/enroot/releases/download/v3.5.0/enroot+caps_3.5.0-1_arm64.deb
